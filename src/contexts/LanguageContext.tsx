...
const translations: Translations = {
  en: {
    ...
    // Tool Instructions
    lessonPlannerDesc: 'Create detailed lesson plans with objectives and activities',
  ...
  ar: {
    ...
    // Tool Instructions
    lessonPlannerDesc: 'إنشاء خطط دروس مفصلة مع الأهداف والأنشطة',
  ...
  he: {
    ...
    lessonPlanner: 'מתכנן שיעורים',
    quizGenerator: 'יוצר מבחנים',
    feedbackAssistant: 'עוזר משוב',
    activityDesigner: 'מעצב פעילויות',
    
    // Tool Instructions
    lessonPlannerDesc: 'צור מערכי שיעור מפורטים עם מטרות ופעילויות',
