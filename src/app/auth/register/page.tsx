...
export default function RegisterPage() {
  ...
  // Move these arrays inside useMemo
  const teacherFeatures = useMemo(() => [
  ...
  ], []); // Empty dependency array since these don't depend on any variables
  ...
  // Update the useEffect to include dependencies
  useEffect(() => {
  ...
  }, [formData.role, teacherFeatures, studentFeatures]); // Add all dependencies
